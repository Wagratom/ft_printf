...
/*   Updated: 2022/06/24 20:18:11 by wwallas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (flg == 1 || flg == 9)
		return (print_char_bonus(va_arg(ptr, int), flg, data));
	else if (flg == 2)
		return (print_str_bonus(va_arg(ptr, char *), data));
	else if (flg == 3)
		return (print_pointer_bonus(flg, data, va_arg(ptr, unsigned long int)));
	else if (flg == 4 || flg == 5)
		return (print_int_bonus(va_arg(ptr, int), data));
	else if (flg == 6)
		return (print_unsigned_bonus(va_arg(ptr, unsigned int), data));
	else if (flg == 7 || flg == 8)
		return (print_hex_bonus(va_arg(ptr, int), flg, data));
	return (1);
}
